<template>
         <v-container class="relative bg-blue-100 d-flex d-sm-none rounded-t-xl h-screen">
            <v-row>
                <v-col cols="12">
                    <v-sheet
                    elevation="0"
                    ...
                    width="100%"
                    color="white"
                    class="pa-4 bg-blue-500/50 text-center rounded-t-xl mx-auto"
                    >
                    <v-row>
                        <v-col cols="4">
                            <v-avatar
                    ...
                    <p class="mb-4 text-start text-slate-600 text-body-3">
                        Status akun anda masih pending tunggu verifikasi admin
                    </p>
